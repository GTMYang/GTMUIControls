...
open class CustomSwitch: UIControl {
    ...
    // 将触点变大
    @IBInspectable open var thumbFatSize: CGFloat = 0 {
        didSet {
            let thumbFatSize_2 = thumbFatSize + thumbFatSize
            self.backgroundView.frame = CGRect(x: thumbFatSize, y: thumbFatSize, width: self.frame.size.width - thumbFatSize_2, height: self.frame.size.height - thumbFatSize_2)
        }
    }
    ...
    fileprivate func setup() {
        ...
        // background
        let thumbFatSize_2 = thumbFatSize + thumbFatSize
        self.backgroundView = UIView(frame: CGRect(x: thumbFatSize, y: thumbFatSize, width: self.frame.size.width - thumbFatSize_2, height: self.frame.size.height - thumbFatSize_2))
        backgroundView.backgroundColor = UIColor.clear
        backgroundView.layer.cornerRadius = (self.frame.size.height - thumbFatSize_2) * 0.5
    ...
    override open func layoutSubviews() {
        ...
        if !isAnimating {
            ...
            // background
            let thumbFatSize_2 = thumbFatSize + thumbFatSize
            backgroundView.frame = CGRect(x: thumbFatSize, y: thumbFatSize, width: frame.size.width - thumbFatSize_2, height: (self.frame.size.height - thumbFatSize_2))
            backgroundView.layer.cornerRadius = self.isRounded ? (self.frame.size.height - thumbFatSize_2) * 0.5 : 2
